...
<!-- Modal -->
<div class="modal fade" id="NuevoCatCoC" tabindex="-1" role="dialog" aria-labelledby="NuevoCatCoCLabel" aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="loginModalLabel">Nueva categoria CoC</h5>
      ...
      <div class="modal-body">
        ...
        <form action="../controllers/catCyC.php" method="POST" id="form-usuario">
          ...
          <div class="mb-3">
            <input type="text" name="nombre" id="nombre" required class="form-control form-input" placeholder="Nombre de la CoC" aria-label="Nombre de la CoC">
          </div>
          
          <div class="mb-3">
            <select class="form-select form-input" required name="criticidad" id="criticidad">
