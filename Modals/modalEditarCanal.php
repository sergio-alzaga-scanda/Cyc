...
<div class="modal fade" id="modalEditarCanal" tabindex="-1" role="dialog" aria-labelledby="modalEditarCanalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEditarCanalLabel">Editar canal digital</h5>
      ...
      <div class="modal-body">
        ...
        <form action="../Controllers/catCanales.php" method="POST" id="form-editar-bot">
          ...
          <div class="mb-3">
            <input type="text" name="nombre" id="edit_nombre_canal" required class="form-control form-input" placeholder="Nombre del canal" aria-label="Nombre del canal">
          </div>
