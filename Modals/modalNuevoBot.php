...
<!-- Modal -->
<div class="modal fade" id="modalNuevoBot" tabindex="-1" role="dialog" aria-labelledby="modalNuevoBotLabel" aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalNuevoBotLabel">Nuevo bot</h5>
      ...
      <div class="modal-body">
        ...
        <form action="../Controllers/catBot.php" method="POST" id="form-usuario">
          ...
          <div class="mb-3">
            <input type="text" name="nombre" id="nombre" required class="form-control form-input" placeholder="Nombre del bot" aria-label="Nombre del bot">
          </div>
    ...
    <div class="btn-container">
        ...
        <button type="submit" class="btn-icon btn-agregar">
            <span>Guardar</span>
